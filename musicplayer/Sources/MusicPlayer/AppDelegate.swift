...
final class AppDelegate: NSObject, NSApplicationDelegate, NSWindowDelegate {
    ...
    private func setupMainMenu() {
        ...
        let appMenu = NSMenu()
        let quitItem = appMenu.addItem(withTitle: "MusicPlayer を終了", action: #selector(quitAction), keyEquivalent: "q")
    ...
    private func setupStatusItem() {
        ...
        item.button?.image = NSImage(systemSymbolName: "music.note", accessibilityDescription: "MusicPlayer")
