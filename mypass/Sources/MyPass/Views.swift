...
func exportBackup(vault: VaultModel) {
    ...
    panel.nameFieldStringValue = "MyPass-\(f.string(from: Date())).\(VaultFile.backupFileExtension)"
...
struct LockView: View {
    ...
    private var titleText: String {
        ...
        return usingRecovery ? "リカバリーキーで解除" : "MyPass"
    }
...
/// MyPass バックアップからの復元。ファイルを選び、バックアップ作成時の
