...
import { loadSquads, tournamentScorers, teamGoalsByPlayer, teamOwnGoals } from "./livedata.js";
  ...
  function matchesCard() {
    ...
    return `<div class="japan-matches">
      ...
      <div class="japan-match-list">${all.map((m) => {
        ...
        if (!played) {
          return `<div class="japan-match-card upcoming">
        ...
        return `<div class="japan-match-card ${outcome}">
