...
import { loadSquads, tournamentScorers, teamGoalsByPlayer, teamOwnGoals } from "./livedata.js?v=22";
import { fetchWiki, fetchPlayerInfo, renderPlayerInfoHtml } from "./wiki.js?v=22";
