...
import { createSchedule } from "./views/schedule.js?v=25";
import { createBracket } from "./views/bracket.js?v=25";
import { createCities } from "./views/cities.js?v=25";
import { createWorld } from "./views/world.js?v=25";
import { createRankings } from "./views/rankings.js?v=25";
import { createStandings } from "./views/standingstab.js?v=25";
import { createTeamList } from "./views/teamlist.js?v=25";
import { createCountry } from "./views/country.js?v=25";
import { createMatchModal } from "./views/matchmodal.js?v=25";
import { fetchLiveData } from "./views/livedata.js?v=25";
import { fetchOpenFootball } from "./views/openfootball.js?v=25";
...
async function refreshLive({ silent } = {}) {
  ...
  try {
    ...
    if (!live.scorers?.length) {
      const { goalRanking } = await import("./views/livedata.js?v=25");
