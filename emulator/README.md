...
```
~/Library/Application Support/RetroGames/Cores/
```
...
> ```bash
> xattr -d com.apple.quarantine ~/Library/Application\ Support/RetroGames/Cores/*.dylib
> ```
...
| 種類 | パス |
|------|------|
| コア | `~/Library/Application Support/RetroGames/Cores/` |
| セーブデータ | `~/Library/Application Support/RetroGames/Saves/` |
| ステートセーブ | `~/Library/Application Support/RetroGames/States/` |
| システム | `~/Library/Application Support/RetroGames/System/` |
